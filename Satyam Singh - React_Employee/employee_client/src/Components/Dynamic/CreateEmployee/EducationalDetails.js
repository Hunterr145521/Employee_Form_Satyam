...
const EducationalDetails = props => {
  ...
  return (
    <>
      ...
      <Button type="button" variant="outlined"  className={styles.previous} onClick={previousPage}>Previous</Button>
      <Button type="submit" variant="outlined"  className={styles.next}>Next</Button>
