  ...
  <ul>
    ...
    {fields.map((member, index) => (
      <li className="reghli" key={index}>
        ...
        <br />
        <Button type="button" variant="outlined" color="secondary" className={styles.removedetails} onClick={() => fields.remove(index)}>Remove Details</Button>
      </li>
    ))}
    <div>
      <Button type="button" variant="outlined" color="primary" className={styles.adddetails} onClick={() => fields.push({})}>Add Details</Button>
...
<Button type="button" variant="outlined" color="secondary" className={styles.previous} onClick={previousPage}>Previous</Button>
<Button type="submit" variant="outlined" color="primary" className={styles.next}>Next</Button>
